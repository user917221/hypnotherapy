            ...
            >
                ...
                <div className="relative z-10 px-2 flex items-center gap-3 shrink-0">
                    ...
                    <a
                        ...
                        className="hidden sm:block text-xs font-black tracking-[0.2em] uppercase bg-[var(--theme-accent)] text-[var(--theme-bg)] px-6 py-3 rounded-full hover:opacity-90 hover:scale-105 transition-all shadow-lg shadow-[var(--theme-accent)]/20 whitespace-nowrap"
                    >
                        Prendre RDV
                    </a>
                </div>
